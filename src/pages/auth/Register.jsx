        ...
        <div className="w-full bg-surface rounded-2xl shadow-2xl md:mt-0 sm:max-w-md xl:p-0 border border-border">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  {/*Nombre completo*/}
                 <div>
                <label htmlFor="nombre" className="block mb-2 text-sm font-medium text-text-main">Ingresa tu nombre completo</label>
                 <div className="relative">
                  ...
                  <p className="text-sm font-light text-text-muted text-center">
                      ¿Ya tienes cuenta? <Link to="/login" className="font-medium text-primary hover:underline">Inicia sesion</Link>
                  </p>
              </form>
            </div>
        </div>
